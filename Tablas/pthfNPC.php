...
$charD00 = [
  ...
  "Major deformity"
   ...
   $char = (Roller($charD00)).", ".(Roller($charD00))." and ".(Roller($charD00));
...
$personalityD00 = [
  ...
  "Asks a kobold glove puppet its opinion at inopportune moments"
   ...
   $personality = Roller($personalityD00);
...
$heroicRewardD00 = [
  ...
  "Marry you"
   ...
   $heroicReward = Roller($heroicRewardD00);
...
<html>
  <head>
    <meta charset="utf-8">
    <title>NPC | Pathfinder | TE</title>
  </head>
  <body>
    <h2>  </h2>
    <p>
      It is a <?=$prof?> <?=$npcBG?> that is trying to <?=$goal?> who will <?=$heroicReward?> as a heroic reward<br>
      <?=$char?><br>
      <?=$personality?><br>
      <?=$secrets?><br>
      <br>
