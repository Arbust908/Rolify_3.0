...
?>
<h1>Rollmaker</h1>
<h2>This tool generates an array of stats via a set of rolls</h2>
<line></line><!-- separation line -->

 <h5> <span style="font-size: 20px;"> Roll 1 : <b><?= statroll() ?></b> </h5><br>
 <h5> <span style="font-size: 20px;"> Roll 2 : <b><?= statroll() ?></b> </h5><br>
 <h5> <span style="font-size: 20px;"> Roll 3 : <b><?= statroll() ?></b> </h5><br>
 <h5> <span style="font-size: 20px;"> Roll 4 : <b><?= statroll() ?></b> </h5><br>
 <h5> <span style="font-size: 20px;"> Roll 5 : <b><?= statroll() ?></b> </h5><br>
 <h5> <span style="font-size: 20px;"> Roll 6 : <b><?= statroll() ?></b> </h5><br>
